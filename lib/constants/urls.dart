class UserUrl {
  ...
  static const String productListUrl = "$userbaseUrl/view_products/";//List all products on the service center 
  static const String simpleRepairRequestUrl = "$userbaseUrl/view_single_repair_request/";// repaire request 
  static const String simpleRepairRequestResponseUrl = "$userbaseUrl/user_update_status/";// repaire request 
  ...
  static const String view_single_charging_station ='$userbaseUrl/view_single_charging_station/';
  static const String feedback = '$userbaseUrl/feedback/';
  static const String user_purchased_products= "$userbaseUrl/user_purchased_products/";
  static const String list_service_centres = '$userbaseUrl/list_service_centres/';
  ...
  static const String view_repair_request = '$userbaseUrl/view_repair_requests/';
  static const String view_vehicle_profile ='$userbaseUrl/user_vehicle_profile/';
